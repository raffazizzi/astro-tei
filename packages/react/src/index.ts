...
import type { Routes as IRoutes } from "./components/BasicRouter";

export { BasicRouter as default, BasicRouter, Behavior, DefaultBehaviors };
export type { TBehavior, IRoutes }